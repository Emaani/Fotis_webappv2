...
export default function Home() {
    return (
        <>
                    ...
                    <div className=' flex justify-center gap-5 mt-10'>
                        <div className=' border px-5 py-2'>
                            <div className=' w-full flex justify-center'>
                                <div className=' h-24 w-24 opacity-80 bg-gray-100 rounded-full text-center justify-center flex flex-col'>
                                    <div className=' flex justify-center w-full b'> <FontAwesomeIcon width={40} icon={faShop} /></div>
                                </div>
                            </div>
                            <p className=' text-center opacity-80  mt-2 font-medium'>Agro products</p>
                        </div>
                        ...
                        <div className='border px-5 py-2'>
                            ...
                            <p className=' text-center opacity-80  mt-2 font-medium'>Transportation </p>
                        </div>
                        <div className='border px-5 py-2'>
                            <div className=' w-full flex justify-center'>
                                <div className=' h-24 w-24 opacity-80 bg-gray-100 rounded-full text-center justify-center flex flex-col'>
                            ...
                            <p className=' text-center opacity-80   mt-2 font-medium'>Warehouses </p>
                        </div>
                        <div className='border px-5 py-2'>
                            <div className=' w-full flex justify-center'>
                                <div className=' h-24 w-24 opacity-80 bg-gray-100 rounded-full text-center justify-center flex flex-col'>
                            ...
                            <p className=' text-center opacity-80 mt-2 font-medium'>Auctions </p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className='horizontal-padding bg-prim-green bg-opacity-5'>
            ...
            <section className='horizontal-padding py-32'>
                <div className=" bg-prim-green shadow-xl border-0 bg-opacity-20 text-white  rounded-lg p-8 md:p-12 mb-8">

                    <h1 className="text-gray-900 dark:text-white text-2xl md:text-5xl font-extrabold mb-2">Become a partner</h1>
                    <p className="text-lg font-normal text-gray-500 mb-4">Are you interested in selling agro products, offering transport services, providing warehouse services, or auctioning your livestock? Register below.</p>
                    <a href="#" className="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-full bg-prim-green hover:bg-prim-orange focus:ring-4 focus:ring-prim-green ">
                        Get started
